...
/**
 * print_octal - converts a number to octal base
...
/**
 * print_hex - Prints a decimal number of base 16 in lowercase
...
/**
 * print_heX - Prints a decimal number of base 16 in Uppercase
 * @list: List of the arguments passed
 * Return: Number of characters printed
 */
